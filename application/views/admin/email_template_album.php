                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:bottom;" width="100%">
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:0;word-break:break-word;">
											...
											Your album has been successfully uploaded. Please make a payment via the link below to make payment.
                                            </div>
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:center;color:#555;">
                                               ...
                                               <a href="<?= site_url('user/upload-payment-album/').$user_id . '/' . $order_id ?>" class="btn btn-primary" target="_blank">Make Payment</a>
                                            </div>
